...
<head>
    ...
    <title>Украшение для десткого праздника и отличный подарок на день рождения - грифельная доска с достижениями ребенка за год</title>
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-xs-6">
                        <form action="/free" role="form" method="post">
                            <div class="form-group">
                                <label for="email1">Ваш email</label>
                                <input name="email" id="email1" class="form-control">
                            </div>
            ...
            <ul class="items clearfix">
                <li>
                    ...
                    <p>
						...
						Сначала я хотеля просто купить доску, но вариант с дизайнеркм постером мне больше понравился, хотя настоящую доску все равно хотим купить.
                    </p>
                </li>
...
<p>Данный способ подойдет вам, если вы не хотите самостоятельно ходить в почтовое отделение. Вам привезут товар и выдадут непосредственно в руки.</p>

<p>Однако, стоимость будет значительная - 400 - 800 руб. в зависимости от вашего фактического местоположения. Оплата - наличные курьеру.</p>

<p>Посылкой (рекомендуемый дешевый вариант). Вы сами забираете посылку с товаром в ближайшем почтовом отделении. Стоимость будет порядка 50-100 руб. Точную стоимость доставки вы можете узнать на сайте почты России. Также, при подтверждении заказа оператор назовет вам точную стоимость.
Оплата - наличные при получении заказа на почте. Внимание! В случае оплаты покупки на сайте вы полуете посылку на почте бесплатно!</p>


<p>Возможно, вы предпочтете пользоваться услугами одной из транспортных компаний из тех, с которыми мы работаем.</p>

<h4>Транспортная компания “Деловые линии”</h4>
<p>Удостоверьтесь, что данная компания отправляет грузы в ваш город\нас. пункт на официальном сайте http://www.dellin.ru/cities/</p>
...
Заказать доставку на дом (произвольный адрес) - стоимость доставки от нашего склада до вашего адреса будет порядка 650 руб.</p>

<h4>Порядок оплаты и получения заказа</h4>
<p>При отправке товара Деловыми линиями или EMS вы вносите 100% предоплату любым удобным вам способом, прежде чем мы передадим ваш заказ в в службу доставки.</p>

<p>В случае, если вы вдруг решите, что товар вам не подходит, то мы без вопросов возвращаем вам полную стоимость товара. В этом случае мы оплачиваете только доставку.</p>

<p>Вы можете вообще не платить за доставку. Для этого нужно выбрать получение товара в почтовом отделении и оплатить покупку при оформлении заказа на сайте.</p>
<p>Если вы предпочтете оплату наличными при получении (наложенный платеж), то стоимость доставки составит порядка 100 руб. В обоих этих случаях вы имеете право вернуть товар, если по каким либо причинам он вам не подошел.</p>
...
<div id="garantii">
    ...
    <p>
		...
		<p>
		Для этого нужно просто написать нам и объяснить, что именно не понравилось. Это поможет сохранить вам деньги, а нам исправить недочеты в будущем.</p>
		<p>
...
<div id="faq">
	...
	<p>В данный момент принимает только платежи на банковскую карту или наличные курьеру. В дальнейшем можно будет оплатить электронными валютами.</p>
	...
	<p>Пришлите нам фото доски и мы вернем вам деньги. Нам важно, чтобы наша работа приносила только радость и счастье.</p>	
...
<div id="opcii">
	...
	<p>
	<b>"Принт Maxi"</b> : Уникальный дизайн (любое количество фраз, рост, вес, количество зубок, первые слова) 999 р.	</p>
	<p>
	<b>"Под ключ"</b> : Дизайн (любое количество фраз, рост, вес, количество зубок, слова)+ Печать на холсте + Оформление в раму  4 999 р. В этом варианте также предусмотрена отправка транспортной компанией или почтой России в любой город РФ. Менеджер предложит вам оптимальный способ доставки при подтверждении заказа.</p>
